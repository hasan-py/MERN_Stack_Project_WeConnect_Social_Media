...
function GlobalPost() {
    ...
    if (posts != null && posts.length === 0) {
        ...
        M.toast({ html: "You don't follow anyone so you have no post in home", classes: "#43a047 red darken-1" })
        return <div></div>
    }
                            ...
                            <div style={{padding:"5px"}}>
                                <Link to={"/profile/"+items.postedBy._id}>
                                    <div style={{ position:"relative" }}>
                                        ...
                                        {
                                            loggedInUser === items.postedBy._id ? <span><i onClick={()=> deletePost(items._id,items.image)} className="material-icons" style={{float:"right",color:"red"}}>delete</i></span> : ""
                                        }
                                    </div>
                                </Link>
                            </div>
